...
<div class="container">
    ...
    <section class="row justify-content-center mt-5">
        <div class="col-lg-8 col-sm-12">
            ...
            <p class="text-secondary">Cadastre uma Tag para ser vinculada a um pedido.</p>
        </div>    
    </section>
        ...
        <div  class="col-lg-8 col-sm-12">
            <form action="../../application/controller.php" method="post">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="nome_tag" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
